...
export const LatexATSPhotoTheme = {
  page: {
  ...
  // Portrait-style photo box (~3cm x 4cm ratio), right side of header
  photo: {
    width: 128,
    height: 160,
    box: "overflow-hidden rounded-md bg-slate-200 ring-1 ring-black/20",
  },
} as const;

export type LatexATSPhotoThemeType = typeof LatexATSPhotoTheme;
