...
export default function StatCard({ title, value, icon, subtitle }: Props) {
  return (
    <div className="group rounded-2xl border border-dark-border bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      <div className="flex items-start justify-between">
        <div className="space-y-2">
        ...
        <div className="rounded-xl bg-info/10 p-3 text-info transition group-hover:bg-info group-hover:text-background">
          {icon}
        </div>
      </div>
    </div>
