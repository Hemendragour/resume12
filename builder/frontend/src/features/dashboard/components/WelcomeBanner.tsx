...
export default function WelcomeBanner({ name, onCreate, onContinue }: Props) {
  return (
    <section className="rounded-3xl bg-linear-to-r from-primary via-tan to-accent p-8 text-background shadow-lg">
      <div className="flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
        <div>
          ...
          <h1 className="mt-2 text-4xl font-bold">Hi, {name} 👋</h1>
        ...
        <div className="flex gap-4">
          <button
            onClick={onContinue}
            className="flex items-center gap-2 rounded-xl bg-background px-6 py-3 font-semibold text-primary transition hover:scale-105"
          >
            <ArrowRight size={18} />
            Continue
          </button>
          ...
          <button
            onClick={onCreate}
            className="flex items-center gap-2 rounded-xl border border-background/30 bg-background/10 px-6 py-3 font-semibold backdrop-blur transition hover:bg-background/20"
          >
            <Plus size={18} />
            New Resume
          </button>
